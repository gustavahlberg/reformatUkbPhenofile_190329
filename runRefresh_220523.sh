...
#cp ${PHENO}/ukb49511.all_fields.h5 ${PHENO}/ukb49511.all_fields.plus.h5

ukbPheno_fn=${PHENO}/ukb51637.tab
ukbMeta_fn=${PHENO}/ukb51637.html
initial="FALSE"                                             
ukbAdd_h5=${PHENO}/ukb49511.all_fields.plus.h5                   
